...
function(a, b) {
    ...
    h.pt.callback = function() {
        ...
        function() {
            c(this).hasClass("xubox_max") ? (layer.restore(a.index), d.restore && d.restore(b)) : (layer.full(a.index, d), d.full && d.full(b))
        }),
    ...
    f.reselect = function() {
        ...
        function() {
            var a = c(this);
            a.parents("." + g[0])[0] || 1 == a.attr("layer") && c("." + g[0]).length < 1 && a.removeAttr("layer")(),
            a = null
        })
    },
    h.pt.IE6 = function(a) {
